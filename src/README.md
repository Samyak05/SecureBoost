...
/Project_Folder
  |-- README.txt
  |-- german_credit_data.csv        <-- You must add this
  |-- 1.VFL + HE 2 Party.ipynb      <-- Main Code
  |-- 2. Parties Comparison.ipynb
  |-- 3. Hyperparameters.ipynb
  |-- 4.Performance_Overhead_Analysis.ipynb
  |-- 5.Encryption Time.ipynb
